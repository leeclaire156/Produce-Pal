                ...
                <div className='card-body' >
                    ...
                    <form className="login-form row g-2 input-group" onSubmit={handleFormSubmit}>
                        ...
                        <div className="col-sm-12">
                            ...
                            <div className="input-group mb-3">
                                <input className="form-control" required="required" placeholder="Password"
                                    ...
                                    id="login-password"
                                    onChange={handleChange}
                                    value={formState.password} aria-describedby="basic-addon1" /><span className="input-group-text" id="basic-addon1"><button className="togglePwdBtn" onClick={togglePassword} type='button'><img src={image ? eye : blindeye} /></button></span>
                            </div>
                        </div>
                        <div>
                        ...
                        <div className="d-grid gap-2 d-md-block mt-4 mb-4">
                            <button className="btn btn-primary mt-2" type="submit" id="login-btn">Log In</button>
                            <Link to="/signup">
